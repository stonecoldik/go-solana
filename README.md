...
[![GoDoc](https://pkg.go.dev/badge/github.com/stonecoldik/go-solana?status.svg)](https://pkg.go.dev/github.com/stonecoldik/go-solana@v1.8.4?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/stonecoldik/go-solana/releases)
[![Build Status](https://github.com/stonecoldik/go-solana/workflows/tests/badge.svg?branch=main)](https://github.com/stonecoldik/go-solana/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/stonecoldik/go-solana/main)](https://www.tickgit.com/browse?repo=github.com/stonecoldik/go-solana&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/stonecoldik/go-solana)](https://goreportcard.com/report/github.com/stonecoldik/go-solana)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/stonecoldik/go-solana/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/stonecoldik/go-solana@v1.8.4
```
...
You can wait for a transaction confirmation using the `github.com/stonecoldik/go-solana/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/stonecoldik/go-solana/programs/address-lookup-table"
...
import (
  ...
  "github.com/stonecoldik/go-solana"
  "github.com/stonecoldik/go-solana/programs/system"
  "github.com/stonecoldik/go-solana/rpc"
...
import (
  ...
  "github.com/stonecoldik/go-solana/rpc"
  "github.com/stonecoldik/go-solana/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/stonecoldik/go-solana/programs/system"
  "github.com/stonecoldik/go-solana/rpc"
  confirm "github.com/stonecoldik/go-solana/rpc/sendAndConfirmTransaction"
  "github.com/stonecoldik/go-solana/rpc/jsonrpc"
  "github.com/stonecoldik/go-solana/rpc/ws"
  "github.com/stonecoldik/go-solana/text"
)
...
import (
  ...
  "github.com/stonecoldik/go-solana/programs/token"
  "github.com/stonecoldik/go-solana/rpc"
)
